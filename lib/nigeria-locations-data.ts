export const NIGERIA_LOCATIONS: Record<string, string[]> = {
  ...
  "Borno": [
    "Abadan", "Askira/Uba", "Bama", "Bayo", "Biu", "Chibok", "Damboa", "Dikwa", "Gubio", 
  ...
  "Imo": [
    ...
    "Oru East", "Oru West", "Owerri Municipal", "Owerri North", "Owerri South", "Onuimo"
  ],
  "Jigawa": [
  ...
  "Ogun": [
    ...
    "Obafemi Owode", "Odeda", "Odogbolu", "Ogun Waterside", "Remo North", "Shagamu", "Yewa North", "Yewa South"
  ],
  "Ondo": [
