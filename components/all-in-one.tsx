      ...
      <div className="max-w-7xl mx-auto md:mt-[70px] px-4 sm:px-6 lg:px-8 pt16 pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 lg:gap-20 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-center mb-[16px] text-[#1A1A1A] md:text-start text-[24px] font-bold md:text-[40px] lg:text-6xl text-balance leading-[100%] md:text-5xl md:mb-[24px] x">
              All You Need in One Platform.
            </h2>
            <p className="text-center md:text-start text-[#4D4D4D] font-normal text-[16px] leading-[24px] text-pretty">
